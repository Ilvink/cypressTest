...
it('API test', () =>{
  ...
  cy.request({
      ...
      expect(response.body.items[0]).to.have.property('tradeNumber').to.equal("111111100122102287")
      console.log(response.body)
      
    });
});
it.only('API test with Should', () =>{
    const reqBody ={
        "page": 1,
        "size": 10,
        "isReviewAwaiting": false,
  ...
  cy.request({
    ...
    isFail: false
  }).its('items[0]').should('contain',{
    tradeNumber: "111111100122102287"
